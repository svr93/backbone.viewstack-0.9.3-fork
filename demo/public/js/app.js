...
Application = {
  initialize: function(callback) {
    return window.appRouter = new AppRouter(callback);
  }
};
...
AppRouter = (function(_super) {
  ...
  AppRouter.prototype.initialize = function(callback) {
...
var buf = [];
buf.push("<div class=\"view-head nav-bar\"><div class=\"nav-bar-button-left\"><div class=\"icon icon-menu\"></div></div><div class=\"nav-bar-title\">Level 1</div><div class=\"nav-bar-button-right\"></div></div><div class=\"view-body\"><div class=\"content\"><h1>Level 1</h1><p>This view is at the start (or bottom) of the stack. You won't be able to pop this view, because there is nothing underneath. This means that manually swiping on the left part of the screen will have no affect.</p><p>All new views will automatically push onto the stack, unless they already exist within it.</p><a href=\"#level2\" class=\"button\">Go to Level 2</a><a href=\"#level3\"><small>Skip to Level 3</small></a></div></div>");;return buf.join("");
};
...
var __templateData = function anonymous(locals) {
var buf = [];
buf.push("<div class=\"view-head nav-bar\"><a href=\"#level1\" class=\"nav-bar-button-left\">Back</a><div class=\"nav-bar-title\">Level 2</div></div><div class=\"view-body\"><div class=\"content\"><h1>Level 2</h1><p>This view is automatically pushed onto the view. You can manually swipe back to the last view.</p><p>Because this view declares a stack, the stack is created on initialization. This means you can refresh the page and still manually swipe back.</p><pre>stack: [\"level1\", \"level2\"]</pre><a href=\"#level3\" class=\"button\">Go to level 3</a></div></div>");;return buf.join("");
};
if (typeof define === 'function' && define.amd) {
  define([], function() {
    return __templateData;
